...
#elif defined(TEST16) // Test maze_test1.txt (same as maze_lecture.txt) without backtracking
//        What single specific particular one-thing is being tested?:
//        What is expected?:
//        What happens?:
#include"game.h"
...
#elif defined(TEST17) // Test maze_test2.txt without backtracking
//        What single specific particular one-thing is being tested?:
//        What is expected?:
//        What happens?:
#include"game.h"
...
int main() {
    ...
    //Setup game
    Game g("maze_test2.txt", num_sharks, frame_time_delay, clearScreen, havePlayerBackTack);
...
int main() {
    ...
    //Setup game
    Game g("maze_test3.txt", num_sharks, frame_time_delay, clearScreen, havePlayerBackTack);
...
#elif defined(TEST19) // Test maze_test4.txt without backtracking
//        What single specific particular one-thing is being tested?:
//        What is expected?:
//        What happens?:
#include"game.h"
...
int main() {
    ...
    //Setup game
    Game g("maze_test4.txt", num_sharks, frame_time_delay, clearScreen, havePlayerBackTack);
...
#elif defined(TEST20) // Test maze_test5.txt without backtracking
//        What single specific particular one-thing is being tested?:
//        What is expected?:
//        What happens?:
#include"game.h"
...
#elif defined(TEST22) // Test maze_test2.txt with backtracking
//        What single specific particular one-thing is being tested?:
//        What is expected?:
//        What happens?:
#include"game.h"
...
#elif defined(TEST23) // Test maze_test3.txt (there is no way to reach the exit) with backtracking
//        What single specific particular one-thing is being tested?:
//        What is expected?:
//        What happens?:
#include"game.h"
...
#elif defined(TEST24) // Test maze_test4.txt with backtracking
//        What single specific particular one-thing is being tested?:
//        What is expected?:
//        What happens?:
#include"game.h"
...
#elif defined(TEST25) // Test maze_test5.txt with backtracking
//        What single specific particular one-thing is being tested?:
//        What is expected?:
//        What happens?:
#include"game.h"
